  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data === 'Login Success') {
        ...
        alert(response.data); // Show the error message from the backend
      }
    } catch (error) {
            ...
            <div className="col-12 col-md-6 text-bg-primary">
              <div className="d-flex align-items-center justify-content-center h-100">
                <div className="col-10 col-xl-8 py-3">
                  ...
                  Transform your body, elevate your spirit. Welcome to the gym where sweat turns dreams into reality. Join us and redefine your limits.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card-body p-3 p-md-4 p-xl-5">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="row gy-3 gy-md-4 overflow-hidden">
                    <div className="col-12">
                      <label htmlFor="email" className="form-label " style={{marginRight:"450px"}}>
