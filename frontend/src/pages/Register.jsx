...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:8080/users', user); // Send POST request to backend
      console.log(response.data);
      alert('user successfully registered') // Log the response from the backend
...
<>
            ...
            <div className="card-body p-3 p-md-4 p-xl-5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="row gy-3 gy-md-4 overflow-hidden">
                  <div className="col-12">
                    <label htmlFor="firstName" className="form-label" style={{marginRight:"450px"}}>
                  ...
                  <div className="col-12">
                    <label htmlFor="lastName" className="form-label" style={{marginRight:"450px"}}>
                  ...
                  <div className="col-12">
                    <label htmlFor="email" className="form-label" style={{marginRight:"490px"}}>
                  ...
                  <div className="col-12">
  <label htmlFor="userName" className="form-label" style={{marginRight:"460px"}}>
  ...
  />
                  ...
                  <div className="col-12">
                    <label htmlFor="password" className="form-label" style={{marginRight:"450px"}}>
                  ...
                  <div className="col-12">
                    <label htmlFor="password" className="form-label" style={{marginRight:"400px"}}>
